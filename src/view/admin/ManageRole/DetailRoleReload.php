                ...
                <div style="padding-left: 16%; width: 100%; padding-right: 2rem">
                  <div class="wrapper">
                    <div style="display: flex; margin-bottom: 1rem; align-items: center;">
                      <p class="Admin_title__1Tk48">Cập nhật phân quyền</p>
                    </div>
                    <form action="../AdminController/AdminIndex.php" id="submit_Form" method="post">
                      <div class="addNhomQuyen">
                        <input type="hidden" name="action" value="update_Role">
                        <input type="hidden" name="MaQuyen" value="<?php echo $IDQuyen ?>">
                        <input id="nameQuyen" type="text" name="TenNhomQuyen" onchange="checkTenQuyen()" placeholder="Thêm nhóm quyền" value="<?php echo $Ten ?>">
                        <a id="huy" href="../AdminController/AdminIndex.php?page=Role" style="margin-left:35%">Hủy</a>
                      ...
                      <div>
                        <table class="Phanquyen-feature">
                          ...
                          <tr class="Table-row-chan">
                            ...
                            <td class="phanquyen-value"><input type="checkbox" <?php echo (PhanQuyenController::kiemtraArray($Danhsachchucnang, 27)) ? 'checked' : ''; ?> name="QuanLyQuyen[]" value="27"></td>
                            <td class="phanquyen-value"><input type="checkbox" <?php echo (PhanQuyenController::kiemtraArray($Danhsachchucnang, 28)) ? 'checked' : ''; ?> name="QuanLyQuyen[]" value="28"></td>
                            <td class="phanquyen-value"><input type="checkbox" <?php echo (PhanQuyenController::kiemtraArray($Danhsachchucnang, 29)) ? 'checked' : ''; ?> name="QuanLyQuyen[]" value="29"></td>
                            <td class="phanquyen-value"><input type="checkbox" <?php echo (PhanQuyenController::kiemtraArray($Danhsachchucnang, 30)) ? 'checked' : ''; ?> name="QuanLyQuyen[]" value="30"></td>
                            <td class="phanquyen-value"></td>
                          </tr>
                          <tr class="Table-row-le">
                            <td class="phanquyen-value">Quản lý Tài khoản</td>
                            <td class="phanquyen-value"><input type="checkbox" <?php echo (PhanQuyenController::kiemtraArray($Danhsachchucnang, 2)) ? 'checked' : ''; ?> name="QuanLyTaiKhoan[]" value="2"></td>
                            <td class="phanquyen-value"><input type="checkbox" <?php echo (PhanQuyenController::kiemtraArray($Danhsachchucnang, 3)) ? 'checked' : ''; ?> name="QuanLyTaiKhoan[]" value="3"></td>
                            <td class="phanquyen-value"><input type="checkbox" <?php echo (PhanQuyenController::kiemtraArray($Danhsachchucnang, 4)) ? 'checked' : ''; ?> name="QuanLyTaiKhoan[]" value="4"></td>
                            <td class="phanquyen-value" style="color:red">x</td>
                            <td class="phanquyen-value"><input type="checkbox" <?php echo (PhanQuyenController::kiemtraArray($Danhsachchucnang, 5)) ? 'checked' : ''; ?> name="QuanLyTaiKhoan[]" value="5"></td>
                          </tr>
                          <tr class="Table-row-chan">
                            <td class="phanquyen-value">Quản lý sản phẩm</td>
                            <td class="phanquyen-value"><input type="checkbox" <?php echo (PhanQuyenController::kiemtraArray($Danhsachchucnang, 6)) ? 'checked' : ''; ?> name="QuanLySanPham[]" value="6"></td>
                            <td class="phanquyen-value"><input type="checkbox" <?php echo (PhanQuyenController::kiemtraArray($Danhsachchucnang, 7)) ? 'checked' : ''; ?> name="QuanLySanPham[]" value="7"></td>
                            <td class="phanquyen-value"><input type="checkbox" <?php echo (PhanQuyenController::kiemtraArray($Danhsachchucnang, 8)) ? 'checked' : ''; ?> name="QuanLySanPham[]" value="8"></td>
                            <td class="phanquyen-value" style="color:red">x</td>
                            <td class="phanquyen-value"><input type="checkbox" <?php echo (PhanQuyenController::kiemtraArray($Danhsachchucnang, 9)) ? 'checked' : ''; ?> name="QuanLySanPham[]" value="9"></td>
                          </tr>
                          <tr class="Table-row-le">
                            <td class="phanquyen-value">Quản lý loại sản phẩm</td>
                            <td class="phanquyen-value"><input type="checkbox" <?php echo (PhanQuyenController::kiemtraArray($Danhsachchucnang, 10)) ? 'checked' : ''; ?> name="QuanLyLoaiSanPham[]" value="10"></td>
                            <td class="phanquyen-value"><input type="checkbox" <?php echo (PhanQuyenController::kiemtraArray($Danhsachchucnang, 11)) ? 'checked' : ''; ?> name="QuanLyLoaiSanPham[]" value="11"></td>
                            <td class="phanquyen-value"><input type="checkbox" <?php echo (PhanQuyenController::kiemtraArray($Danhsachchucnang, 12)) ? 'checked' : ''; ?> name="QuanLyLoaiSanPham[]" value="12"></td>
                            <td class="phanquyen-value"><input type="checkbox" <?php echo (PhanQuyenController::kiemtraArray($Danhsachchucnang, 13)) ? 'checked' : ''; ?> name="QuanLyLoaiSanPham[]" value="13"></td>
                            <td class="phanquyen-value" style="color:red">x</td>
                          </tr>
                          <tr class="Table-row-chan">
                            <td class="phanquyen-value">Quản lý nhà cung cấp</td>
                            <td class="phanquyen-value"><input type="checkbox" <?php echo (PhanQuyenController::kiemtraArray($Danhsachchucnang, 14)) ? 'checked' : ''; ?> name="QuanLyNhaCungCap[]" value="14"></td>
                            <td class="phanquyen-value"><input type="checkbox" <?php echo (PhanQuyenController::kiemtraArray($Danhsachchucnang, 15)) ? 'checked' : ''; ?> name="QuanLyNhaCungCap[]" value="15"></td>
                            <td class="phanquyen-value"><input type="checkbox" <?php echo (PhanQuyenController::kiemtraArray($Danhsachchucnang, 16)) ? 'checked' : ''; ?> name="QuanLyNhaCungCap[]" value="16"></td>
                            <td class="phanquyen-value"><input type="checkbox" <?php echo (PhanQuyenController::kiemtraArray($Danhsachchucnang, 17)) ? 'checked' : ''; ?> name="QuanLyNhaCungCap[]" value="17"></td>
                            <td class="phanquyen-value" style="color:red">x</td>
                          </tr>
                          <tr class="Table-row-le">
                            <td class="phanquyen-value">Phiếu nhập kho</td>
                            <td class="phanquyen-value"><input type="checkbox" <?php echo (PhanQuyenController::kiemtraArray($Danhsachchucnang, 18)) ? 'checked' : ''; ?> name="QuanLyPhieuNhapKho[]" value="18"></td>
                            <td class="phanquyen-value"><input type="checkbox" <?php echo (PhanQuyenController::kiemtraArray($Danhsachchucnang, 19)) ? 'checked' : ''; ?> name="QuanLyPhieuNhapKho[]" value="19"></td>
                            <td class="phanquyen-value" style="color:red">x</td>
                            <td class="phanquyen-value" style="color:red">x</td>
                            <td class="phanquyen-value" style="color:red">x</td>
                          ...
                          <tr class="Table-row-chan">
                            ...
                            <td class="phanquyen-value"><input type="checkbox" <?php echo (PhanQuyenController::kiemtraArray($Danhsachchucnang, 21)) ? 'checked' : ''; ?> name="QuanLyDonHang[]" value="21"></td>
                            <td class="phanquyen-value" style="color:red">x</td>
                            <td class="phanquyen-value"><input type="checkbox" <?php echo (PhanQuyenController::kiemtraArray($Danhsachchucnang, 22)) ? 'checked' : ''; ?> name="QuanLyDonHang[]" value="22"></td>
                            <td class="phanquyen-value" style="color:red">x</td>
                            <td class="phanquyen-value" style="color:red">x</td>
                          </tr>
                          <tr class="Table-row-le">
                            <td class="phanquyen-value">Quản lý Người dùng</td>
                            <td class="phanquyen-value"><input type="checkbox" <?php echo (PhanQuyenController::kiemtraArray($Danhsachchucnang, 23)) ? 'checked' : ''; ?> name="QuanLyNguoiDung[]" value="23"></td>
                            <td class="phanquyen-value"><input type="checkbox" <?php echo (PhanQuyenController::kiemtraArray($Danhsachchucnang, 24)) ? 'checked' : ''; ?> name="QuanLyNguoiDung[]" value="24"></td>
                            <td class="phanquyen-value"><input type="checkbox" <?php echo (PhanQuyenController::kiemtraArray($Danhsachchucnang, 25)) ? 'checked' : ''; ?> name="QuanLyNguoiDung[]" value="25"></td>
                            <td class="phanquyen-value"><input type="checkbox" <?php echo (PhanQuyenController::kiemtraArray($Danhsachchucnang, 26)) ? 'checked' : ''; ?> name="QuanLyNguoiDung[]" value="26"></td>
                            <td class="phanquyen-value" style="color:red">x</td>
                          </tr>
                          <tr class="Table-row-chan">
                            <td class="phanquyen-value">Thống kê tổng quát</td>
                            <td class="phanquyen-value"><input type="checkbox" <?php echo (PhanQuyenController::kiemtraArray($Danhsachchucnang, 31)) ? 'checked' : ''; ?> name="ThongKe[]" value="31"></td>
                            <td class="phanquyen-value" style="color:red">x</td>
                            <td class="phanquyen-value" style="color:red">x</td>
                            <td class="phanquyen-value" style="color:red">x</td>
                            <td class="phanquyen-value" style="color:red">x</td>
                          ...
                          <tr class="Table-row-le">
                            ...
                            <td class="phanquyen-value"><input type="checkbox" <?php echo (PhanQuyenController::kiemtraArray($Danhsachchucnang, 32)) ? 'checked' : ''; ?> name="ThongKe[]" value="32"></td>
                            <td class="phanquyen-value" style="color:red">x</td>
                            <td class="phanquyen-value" style="color:red">x</td>
                            <td class="phanquyen-value" style="color:red">x</td>
                            <td class="phanquyen-value" style="color:red">x</td>
