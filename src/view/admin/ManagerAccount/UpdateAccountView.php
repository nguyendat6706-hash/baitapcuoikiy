...
display: flex;
                    ...
                    <form id="submit-form" action="../AdminController/AdminIndex.php" method="post">
                      ...
                      <input type="hidden" name="MaTaiKhoan" id="MaTaiKhoan" value="<?php echo $DataNguoiDung['MaTaiKhoan'] ?>" />
                      <div class="boxFeature">
                        <div>
                          <h2 style="font-size: 2.3rem">Sửa / xem cập nhật tài khoản</h2>

                        </div>
                        <div>
                          <a href="../AdminController/AdminIndex.php?page=Account&numpage=1" style="
                              font-family: Arial;
                              font-size: 1.5rem;
                              font-weight: 700;
                        ...
                        <div style="
                          ...
                          <div>
                            ...
                            <div style="padding-left: 1rem">
                              ...
                              <input id="HoTen" class="input" type="text" name="taikhoan" readonly style="width: 40rem" value="<?php echo $DataNguoiDung['TenDangNhap'] ?>" />
                              <span style="
                                  margin-left: 1rem;
                                  font-weight: 700;
                              ...
                              <div style="display: flex; gap: 2rem">
                                ...
                                <input id="matkhau" type="hidden" class="input" name="password" value="<?php echo $DataNguoiDung['MatKhau'] ?> " />
                              </div>
                              <div>
                                ...
                                <select name="DoiTuong" id="vaitro" class="input">
                                  ...
                                  foreach ($Result as $record) {
                                    // Kiểm tra nếu quyền của người dùng khác 1 và mã quyền của dòng hiện tại không phải là 1
                                    if ($DataNguoiDung['MaQuyen'] != 1 && $record['MaQuyen'] != 1) {
                                      // Hiển thị các mã quyền ngoại trừ 1
                                      if ($DataNguoiDung['MaQuyen'] == $record['MaQuyen']) {
                                  ...
                                  // Hiển thị tất cả các mã quyền nếu quyền của người dùng là 1
                                  if ($DataNguoiDung['MaQuyen'] == 1) {

                                    echo "<option selected value=" . $DataNguoiDung['MaQuyen'] . ">" . "Admin" . "</option>";
                                  }
...
<script>
  ...
  //   $.ajax({
  //     type: "POST",
  //     url: "../controller/AdminIndex.php",
  //     data: formData,
  //     success: function(response) {
  //       console.log('Response:', response);
  //       var tempElement = $('<div>').html(response);
  //       var newTbody = tempElement.find('#Update_input');
  //       var currentTbody = $('#Update_input');
  //       currentTbody.replaceWith(newTbody);
  //       $('#doituong').off('change').on('change', function() {
  //         selectDoiTuong(this);
  //       });
  //     },
  //     error: function() {
