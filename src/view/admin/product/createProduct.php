                    ...
                    <form method="POST" class="createProduct">
                      ...
                      <div class="container__boxFeature">
                        <div>
                          ...
                          <input class="input" placeholder="Nhập Tên Sản Phẩm" name="TenSanPham" required />
                          <span style="margin-left: 1rem;font-weight: 700;color: rgb(150, 150, 150);">*</span>

                          <div>
                            <p class="text">Nồng Độ Cồn</p>
                            <input type="number" class="input" placeholder="Nồng Độ" name="NongDo" required />
                          </div>
                          <div>
                            <p class="text">Dung Tích</p>
                            <input type="number" class="input" placeholder="Dung Tích" name="TheTich" />
                          </div>

                          <div>
                            <p class="text">Giá Tiền</p>
                            <input type="number" class="input" placeholder="Giá Bán Sản Phẩm" name="Gia" required />
                          </div>
                          <div>
                            <p class="text">Xuất xứ</p>
                            <input class="input" placeholder="Xuất Xứ Nguồn Gốc Sản Phẩm" name="XuatXu" required />
                          </div>
                          <div>
                            <p class="text">Thương Hiệu</p>
                            <input class="input" placeholder="Thương Hiệu" name="ThuongHieu" required />
                          </div>
                          <p class="text">Loại Sản Phẩm</p>
                          <select id="loaiSanPham" name="loaiSanPham" required>
                            <?php
                            foreach ($dataGetLoaiSanPham as $getLoaiSanPham) {
                              echo "<option value='" . $getLoaiSanPham['MaLoaiSanPham'] . "'>" . $getLoaiSanPham['TenLoaiSanPham'] . "</option>";
                            }
                            ?>
                          </select>
