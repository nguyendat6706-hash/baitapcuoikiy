                ...
                <div style="padding-left: 16%; width: 100%; padding-right: 2rem">
                  <div class="wrapper">
                    ...
                    <div class="boxFeature">
                      <div>
                        <h2 style="font-size: 2.3rem">Sản phẩm</h2>
                        <p style="font-size: 1.1rem; font-weight: 700">
                          Sản Phẩm / Xem và chỉnh sửa
                        </p>
                      </div>
                      <div>
                        <button class="btn__cancel" style="
                              font-family: Arial;
                              font-size: 1.5rem;
                              font-weight: 700;
                    ...
                    <form method="POST" class="updateProduct">
                      <h2>Thông Tin Sản Phẩm</h2>
                      <div class="container__boxFeature">
                        <div>
                          <p class="text">Tên Sản Phẩm</p>
                          <input class="input" placeholder="Nhập Tên Sản Phẩm" name="TenSanPham" value="<?php echo isset($dataProduct['TenSanPham']) ? $dataProduct['TenSanPham'] : ''; ?>" required />
                          <span style=" margin-left: 1rem;font-weight: 700;color: rgb(150, 150, 150);">*</span>

                          <div>
                            <p class="text">Nồng Độ Cồn</p>
                            <input type="number" step="any" class="input" placeholder="Nồng Độ" name="NongDo" value="<?php echo isset($dataProduct['NongDoCon']) ? $dataProduct['NongDoCon'] : ''; ?>" required />
                          </div>
                          <div>
                          ...
                          <div>
                            ...
                            <input class="input" placeholder="Xuất Xứ Nguồn Gốc Sản Phẩm" name="XuatXu" value="<?php echo isset($dataProduct['XuatXu']) ? $dataProduct['XuatXu'] : ''; ?>" required />
                          </div>
                          <div>
                            <p class="text">Thương Hiệu</p>
                            <input class="input" placeholder="Thương Hiệu" name="ThuongHieu" value="<?php echo isset($dataProduct['ThuongHieu']) ? $dataProduct['ThuongHieu'] : ''; ?>" required />
                          </div>
                          <p class="text">Loại Sản Phẩm</p>
                          <select id="loaiSanPham" name="loaiSanPham" required>
                            <?php
                            foreach ($dataGetLoaiSanPham as $getLoaiSanPham) {
                              $selected = '';
                              if ($getLoaiSanPham['TenLoaiSanPham'] === $dataProduct['TenLoaiSanPham']) {
                                $selected = 'selected';
                              }
                              echo "<option value='" . $getLoaiSanPham['MaLoaiSanPham'] . "' $selected>" . $getLoaiSanPham['TenLoaiSanPham'] . "</option>";
                            }
                            ?>
                          </select>
                        ...
                        <div>
                          <div>
                            <p style="font-weight: 700;color: rgb(100, 100, 100);line-height: 2;margin-top: 2rem;">
                              Lưu ý các sản phẩm được đưa vào doanh nghiệp phải đảm bảo các quy chuẩn như sau:
                              <br />* Nguồn gốc xuất xứ rõ ràng *
                              <br />* Sản phẩm từ nhà cung cấp được qua kiểm duyệt sàn lọc trước khi đưa vào doanh nghiệp *
                              <br />* Đảm bảo chất lượng cao nhất cho từng sản phẩm *
                            </p>
