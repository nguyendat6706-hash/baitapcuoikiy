...
<head>
  ...
  <link rel="stylesheet" href="/UTH-PHP/src/view/admin/supplier/updateSupplier.css" />
                ...
                <div style="padding-left: 16%; width: 100%; padding-right: 2rem">
                  <div class="wrapper">
                    ...
                    <div class="boxFeature">
                      <div>
                        <h2 style="font-size: 2.3rem">Nhà Cung Cấp</h2>
                        <p style="font-size: 1.1rem; font-weight: 700">
                          Nhà Cung Cấp / Xem và chỉnh sửa
                        </p>
                      </div>
                      <div>
                    ...
                    <form method="POST" class="updateSupplierForm" key="<?php echo $dataSupplier['MaNCC'] ?>">
                      <h2>Thông Tin Sản Phẩm</h2>
                      <div class="container__boxFeature">
                        <div>
                          <p class="text">Tên Nhà Cung Cấp</p>
                          <input class="input" placeholder="Nhập tên nhà cung cấp" name="TenNhaCungCap" value="<?php echo $dataSupplier['TenNCC']; ?>" required />
                          <span style="margin-left: 1rem;font-weight: 700;color: rgb(150, 150, 150);">*</span>

                          <div>
                            <p class="text">Số Điện Thoại</p>
                            <input type="text" class="input" placeholder="Số điện thoại nhà cung cấp" name="SoDienThoai" value="<?php echo $dataSupplier['SoDienThoai']; ?>" required />
                          </div>

                          <div>
                            <p class="text">Email</p>
                            <input type="email" class="input" placeholder="Email nhà cung cấp" name="Email" value="<?php echo $dataSupplier['Email']; ?>" required />
                          </div>
                        </div>
